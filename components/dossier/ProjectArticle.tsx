...
export default function ProjectArticle({
  ...
  const body = (
    <div className="grid min-w-0 gap-12 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,2.2fr)] lg:items-start lg:gap-10">
  ...
  if (!rise) {
    return (
      <article className="sheet-pad min-w-0 overflow-x-hidden pb-24 pt-12 sm:pb-32 sm:pt-16">{body}</article>
    );
  }

  return (
    <article className="sheet-pad min-w-0 overflow-x-hidden pb-24 pt-12 sm:pb-32 sm:pt-16">
